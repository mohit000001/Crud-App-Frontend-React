...
function Home() {
    ...
    <PageCardWrapper Element={
       ...
       <ul>
           <li style={{margin:10}}> <b>Frontend Techs </b> : Reactjs, Typescript, AWS, React Router, Matrail UI, React hook form, Axios</li>
           <li style={{margin:10}}> <b>Backend Techs </b> : Nodejs, AWS, ExpressJs, MongoDB, Mongoss, Typescript</li>
